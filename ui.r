...
ui = fluidPage(
    ...
    headerPanel(h3("Twitter Sentiment Analysis: Team 5"), windowTitle = "TWITTER ANALYSIS"),
    ...
    sidebarLayout(
        ...
        sidebarPanel(
            ...
            numericInput("numberInput", "Select number of tweets",
        ...
        mainPanel(
            ...
            tabsetPanel(
                ...
                tabPanel("Ratio Plots TM", plotOutput("plot2")),
